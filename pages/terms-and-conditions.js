        ...
        <div className="main s2">
            <div className="container">
                <div className="wrapper">
                    ...
                    <p>Welcome to yashcan.com!</p>

                    <p>
                        These terms and conditions outline the rules and
                        regulations for the use of YashCan Incorporated’s
                        Website, located at https://www.yashcan.com.
                    </p>

                    <p>
                        By accessing this website we assume you accept these
                        terms and conditions. Do not continue to use yashcan.com
                    ...
                    <p>
                        We employ the use of cookies. By accessing yashcan.com,
                        you agreed to use cookies in agreement with the YashCan
                    ...
                    <p>
                        Unless otherwise stated, YashCan Incorporated and/or its
                        licensors own the intellectual property rights for all
                        material on yashcan.com. All intellectual property
                        rights are reserved. You may access this from
                        yashcan.com for your own personal use subjected to
                        restrictions set in these terms and conditions.
                    </p>

                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from yashcan.com</li>
                        <li>
                            Sell, rent or sub-license material from yashcan.com
                        </li>
                        <li>
                            Reproduce, duplicate or copy material from
                            yashcan.com
                        </li>
                        <li>Redistribute content from yashcan.com</li>
                    </ul>
                    ...
                    <p>
                        ...
                        YashCan Incorporated shall not be liable for the
                    ...
                    <p>
                        YashCan Incorporated reserves the right to monitor all
                    ...
                    <p>
                        You hereby grant YashCan Incorporated a non-exclusive
                    ...
                    <p>
                        ...
                        YashCan Incorporated; and (d) the link is in the context
                    ...
                    <p>
                        ...
                        you must inform us by sending an e-mail to YashCan
                        Incorporated. Please include your name, your
                    ...
                    <p>
                        No use of YashCan Incorporated’s logo or other artwork
